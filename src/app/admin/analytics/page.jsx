...
export default function Analytics() {
  ...
  if (loading)
    return (
      <div className="flex items-center justify-center h-screen bg-white/80 dark:bg-gray-900/50 text-gray-500 dark:text-white">
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-10">
        ...
        <Card>
          <CardContent className="p-4 text-center">
           ...
           {/* Calls Table */}
      <div className="overflow-x-auto max-md:max-w-[345px] h-[100vh] scrollar rounded-xl">
        <table className="w-[400%] md:max-w-[150%] border-collapse border border-gray-300 dark:border-gray-700">
